        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Button variant="outline" size="sm" className="w-full h-9" aria-label="Sign up with Google">
                <FcGoogle className="h-4 w-4" />
              </Button>
              <Button variant="outline" size="sm" className="w-full h-9" aria-label="Sign up with Meta">
                <FaMeta className="h-4 w-4" />
              </Button>
              <Button variant="outline" size="sm" className="w-full h-9" aria-label="Sign up with Twitter">
